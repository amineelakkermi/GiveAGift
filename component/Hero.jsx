    ...
    <div dir="rtl" className="absolute bottom-0 flex translate-y-4 justify-center items-center mt-4 mb-0 relative">
      <Image
        ...
        className="object-cover -z-10 translate-y-28 -translate-x-8
          w-full max-w-[160px] sm:max-w-[200px] lg:max-w-[240px] xl:max-w-[300px] -ml-[10%]"
      />
      <picture>
        ...
        <Image
          src={mockup1}
          alt="App Screen 1"
          className="w-full object-cover translate-y-20 sm:translate-y-16 xl:translate-y-6 
      ...
      <Image
        ...
        alt="App Screen 3"
        className="object-cover -z-10 translate-y-28 translate-x-8
          w-full max-w-[160px] sm:max-w-[200px] lg:max-w-[240px] xl:max-w-[300px] -mr-[10%]"
      />
    </div>
  </div>
</section>
