...
import { useLanguage } from "./LanguageProvider"; // Contexte global

export default function LoginComponent({ isOpen, setIsOpen }) {
  const { lang, setLang } = useLanguage(); // utilisation du provider global
        ...
        <div className="absolute top-4 right-4 flex gap-2">
          <button
            ...
            className={`px-3 py-1 rounded ${
              lang === "ar" ? "bg-red-500 text-white" : "bg-gray-200"
            }`}
          >
            AR
          </button>
          <button
            onClick={() => setLang("en")}
            className={`px-3 py-1 rounded ${
              lang === "en" ? "bg-red-500 text-white" : "bg-gray-200"
            }`}
          >
            EN
          </button>
